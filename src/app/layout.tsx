...
export const metadata: Metadata = {
  ...
  description: 'myappcube is an independent mobile app studio. Download El Infiltrado and more on Android and iOS.',
  keywords: ['mobile apps', 'mobile games', 'party games', 'android apps', 'ios apps', 'el infiltrado', 'myappcube', 'juegos movil', 'apps moviles'],
  ...
  openGraph: {
    ...
    description: 'myappcube is an independent mobile app studio.',
